...
<div>
    <div style="margin: 10px;">
        <h3>Menu</h3>
        <a class="link-button" href="${pageContext.request.contextPath}/car-save">Új autó rögzítése</a>
        <a class="link-button" href="${pageContext.request.contextPath}/car-list">Autók listája</a>
