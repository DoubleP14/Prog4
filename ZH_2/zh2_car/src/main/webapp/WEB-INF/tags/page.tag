...
<body>
	...
	<div>
		<div style="margin: 10px;">
			<h3>Menu</h3>
			<a class="link-button" href="${pageContext.request.contextPath}/save-car">Add new car</a>
			<a class="link-button" href="${pageContext.request.contextPath}/car-list">Car list</a>
